#!/usr/bin/env bash
# Creates a CLI-factory feature folder under .tlk/features/ (designing-cli skill).
# Usage: .claude/skills/designing-cli/new-cli.sh <api-slug>
# Example: .claude/skills/designing-cli/new-cli.sh linear
...
elif [ -d "talaka/skills/designing-cli/templates" ]; then
  TPL="talaka/skills/designing-cli/templates"
else
  echo "ERROR: cannot locate designing-cli templates dir" >&2
  exit 2
fi
