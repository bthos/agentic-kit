...
_Filled by /designing-cli (Phase 2). The agent-native contract below is acceptance criteria for Bagnik's code QA — hard rules, not suggestions._
...
- [ ] [anything planning-architecture must settle before tests are written]
