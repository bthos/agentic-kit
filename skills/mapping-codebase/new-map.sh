...
# Usage: .claude/skills/mapping-codebase/new-map.sh <slug>
# Example: .claude/skills/mapping-codebase/new-map.sh payments-service
...
elif [ -d "talaka/skills/mapping-codebase/templates" ]; then
  TPL="talaka/skills/mapping-codebase/templates"
else
  echo "ERROR: cannot locate mapping-codebase templates dir" >&2
  exit 2
fi
