...
_Filled by /mapping-codebase. Read by planning-architecture, eliciting-requirements, and any agent onboarding to this code. A map is **edges, not just nodes** — name how the parts call each other, not only what exists._
