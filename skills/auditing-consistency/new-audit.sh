...
# Usage: .claude/skills/auditing-consistency/new-audit.sh <slug>
# Example: .claude/skills/auditing-consistency/new-audit.sh model-naming
...
elif [ -d "talaka/skills/auditing-consistency/templates" ]; then
  TPL="talaka/skills/auditing-consistency/templates"
else
  echo "ERROR: cannot locate auditing-consistency templates dir" >&2
  exit 2
fi
