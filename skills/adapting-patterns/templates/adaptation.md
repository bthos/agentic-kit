...
_Filled by /adapting-patterns (Phase 2). Read by planning-architecture (builds it) and Bagnik (gates it). Maps the source's core insight onto **this** project's conventions — not a copy of the original._
