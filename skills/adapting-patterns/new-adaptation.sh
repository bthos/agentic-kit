...
# Usage: .claude/skills/adapting-patterns/new-adaptation.sh <slug>
# Example: .claude/skills/adapting-patterns/new-adaptation.sh llm-wiki
...
elif [ -d "talaka/skills/adapting-patterns/templates" ]; then
  TPL="talaka/skills/adapting-patterns/templates"
else
  echo "ERROR: cannot locate adapting-patterns templates dir" >&2
  exit 2
fi
