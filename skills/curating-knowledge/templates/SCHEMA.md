...
This file is the **ontology** for `wiki/` — the conventions curating-knowledge follows on every ingest, query, and lint. Amend it to fit the project (add categories, page types, naming rules); curating-knowledge reads it before every operation and obeys what it finds here.
